            ...
            <Card heading="Fertilizer Combination 1 :">
                <View style={{flexDirection: "row", justifyContent: "space-around", width: "95%", marginTop: 15}}>
                    <View style={{alignItems: "center"}}>
                        <Text>Nitrogen</Text>
                        <Image source={require("../../utils/icons/nitrogen.png")} style={{width: 50, height: 50, borderRadius: 5, marginTop: 5, marginBottom: 10}} />
                        <Text style={{color: "green",fontSize: 25}}>44.5%</Text>
                    </View>
                    <View style={{width: 0.5, height :"85%", backgroundColor: "black"}} />
                    <View style={{alignItems: "center"}}>
                        <Text>Phosphorus</Text>
                        <Image source={require("../../utils/icons/phosphorus.png")} style={{width: 50, height: 50, borderRadius: 5, marginTop: 5, marginBottom: 10}} />
                        <Text style={{color: "green",fontSize: 25}}>30.0%</Text>
                    </View>
                    <View style={{width: 0.5, height :"85%", backgroundColor: "black"}} />
                    <View style={{alignItems: "center"}}>
                        <Text>Potassium</Text>
                        <Image source={require("../../utils/icons/potassium.png")} style={{width: 50, height: 50, borderRadius: 5, marginTop: 5, marginBottom: 10}} />
