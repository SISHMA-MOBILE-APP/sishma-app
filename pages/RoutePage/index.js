import { StyleSheet, Text, View, TextInput, Modal, Dimensions, TouchableOpacity } from 'react-native';
...
export default function Welcome() {
    ...
    return (
        <View style={styles.container}>
            <LinearGradient
                style={[styles.circle, { transform: [{ rotate: "0deg", }], top: -120, left: -160 }]}
                colors={['#094525', colors.greenTint80 ]}
                start={{ x: 0.25, y: 0.75 }}
                end={{ x: 1, y: 1 }} />
            <LinearGradient
                style={[styles.circle, { transform: [{ rotate: "103deg", }], top: -125, left: 30 }]}
                colors={['#1ddf76', '#128a49']} />
            <LinearGradient
                style={[styles.circle, { transform: [{ rotate: "6.5deg", }], top: -40, left: -95 }]}
                colors={['rgba(30,182,103,0.49)', 'rgba(6,105,44, 0.8)']}
                start={{ x: 0.25, y: 0.25 }}
                end={{ x: 1, y: 1 }} />
            <LinearGradient
                style={[styles.circle, { transform: [{ rotate: "123deg", }], top: -220, left: -40 }]}
            ...
            <View style={{top: 410}}>
                <RouteButton text="Farmer Registration"/>
                <RouteButton text="Admin Registration"/>
                <RouteButton text="Officer Registration"/>
            </View>
        </View>
    );
}
