            ...
            <View style={styles.body}>
                ...
                <View style={styles.cardcontainer}>
                    ...
                    <ItemCard onClick={()=>language("hindi")}>
                        ...
                        <Text style={{ fontSize: 17, marginTop: 15, color: "#3d3d3d", fontWeight: "bold", }}>Hindi</Text>
                    </ItemCard>
                </View>
                <View style={styles.cardcontainer}>
                    <ItemCard onClick={()=>language("tamil")}>
                        ...
                        <Text style={{ fontSize: 17, marginTop: 15, color: "#3d3d3d", fontWeight: "bold", }}>Tamil</Text>
                    </ItemCard>
                </View>
